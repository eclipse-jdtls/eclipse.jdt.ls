 ...
 *
 * Copied from package org.eclipse.jdt.internal.ui.fix.IMultiFix
 *
 * Contributors:
...
public interface IMultiFix extends ICleanUp {
	...
	/**
	 * True if <code>problem</code> in <code>ICompilationUnit</code> can be fixed by
	 * this CleanUp.
	 * <p>
	...
	/**
	 * Maximal number of problems this clean up will fix in compilation unit. There
	 * may be less then the returned number but never more.
	 *
	 * @param compilationUnit
	 *            The compilation unit to fix, not null
