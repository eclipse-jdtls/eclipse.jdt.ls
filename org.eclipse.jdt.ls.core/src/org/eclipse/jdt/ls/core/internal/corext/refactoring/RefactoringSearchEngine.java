 ...
 *
 * Originally copied from org.eclipse.jdt.internal.corext.refactoring.RefactoringSearchEngine
 *
 * Contributors:
...
public class RefactoringSearchEngine {
	...
	//TODO: throw CoreException
	public static ICompilationUnit[] findAffectedCompilationUnits(SearchPattern pattern, IJavaSearchScope scope, final IProgressMonitor pm, RefactoringStatus status) throws JavaModelException {
	 ...
	 * @param status
	 *            an error is added here if inaccurate or non-cu matches have been
	 *            found
