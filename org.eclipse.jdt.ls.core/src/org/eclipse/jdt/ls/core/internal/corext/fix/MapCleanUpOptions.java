 ...
 *
 * Copied from package org.eclipse.jdt.internal.ui.fix.MapCleanUpOptions
 *
 * Contributors:
...
public class MapCleanUpOptions extends CleanUpOptions {
	...
	/**
	 * Create new CleanUpOptions instance. <code>options</code> maps named clean ups
	 * keys to {@link CleanUpOptions#TRUE}, {@link CleanUpOptions#FALSE} or any
	 * String value
	 *
	 * @param options
