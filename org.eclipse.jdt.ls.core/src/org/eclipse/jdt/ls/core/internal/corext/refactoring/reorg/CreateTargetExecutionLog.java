 ...
 *
 * Originally copied from org.eclipse.jdt.internal.corext.refactoring.reorg.CreateTargetExecutionLog
 *
 * Contributors:
...
public final class CreateTargetExecutionLog {
	...
	private Map<Object, Object> fCreations = new LinkedHashMap<>(2);
