 ...
 *
 * Copied from org.eclipse.jdt.internal.corext.dom.ModifierRewrite
 *
 * Contributors:
...
public class ModifierRewrite {
	...
	/**
	 * Sets the given modifiers. Removes all other flags, but leaves annotations in
	 * place.
	 *
	 * @param modifiers
	...
	/**
	 * Sets the included modifiers and removes the excluded modifiers. Does not
	...
	/**
	 * Sets the included visibility modifiers and removes existing visibility
	 * modifiers. Does not touch other flags and leaves annotations in place.
	 *
	 ...
	 *            the edit group in which to collect the corresponding text edits,
	 *            or <code>null</code> if ungrouped
	 * @return a tracked position that contains the changed modifiers, or
	 *         <code>null</code> iff <code>editGroup == null</code>
	 */
	...
	/**
	 * Sets the given modifiers and removes all other modifiers that match the
	 * consideredFlags mask. Does not touch other flags and leaves annotations in
	 * place.
	 *
	 * @param modifiers
	 *            the modifiers to set
