...
public interface IRefactoringProcessorIds {
	...
	/**
	 * Save mode to save all editors that are known to cause trouble for Java
	 * refactorings, e.g. editors on compilation units that are not in working copy
	 * mode.
	 */
	public static final int SAVE_REFACTORING = 4;
	/**
	 * Processor ID of the rename Java project processor (value
	 * <code>"org.eclipse.jdt.ui.renameJavaProjectProcessor"</code>).
	 *
