...
public final class RefactoringAvailabilityTester {
	...
	//		return (selection.resolveInMethodBody() || selection.resolveInClassInitializer() || selection.resolveInVariableInitializer()) && !selection.resolveInAnnotation()
	...
	//		return (selection.resolveInMethodBody() || selection.resolveInClassInitializer()) && !selection.resolveInAnnotation()
	...
	//		return selection.resolveInMethodBody() && !selection.resolveInAnnotation() && isIntroduceParameterAvailable(selection.resolveSelectedNodes(), selection.resolveCoveringNode());
	//	}
	//
