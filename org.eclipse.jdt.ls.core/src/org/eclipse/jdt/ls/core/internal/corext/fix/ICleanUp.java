 ...
 *
 * Copied from package org.eclipse.jdt.ui.cleanup.ICleanUp
 *
 * Contributors:
 ...
 * {@link #getRequirements()}. The clean up can request an AST and define how to
 * build this AST. It can base its requirements on the options passed through
 * {@link #setOptions(CleanUpOptions)}.
 * </p>
 * <p>
 * A context containing the information requested by the requirements are passed
 * to {@link #createFix(CleanUpContext)}. A fix capable of fixing the problems
 * is returned by this function if
 * {@link #checkPreConditions(IJavaProject, ICompilationUnit[], IProgressMonitor)}
...
public interface ICleanUp {
	 ...
	 * <p>
	 * <strong>Note:</strong> This method must only be called after the options have
	 * been set.
	 * </p>
	 *
	 * @return descriptions an array of {@linkplain String strings} or
	 *         <code>null</code>
	 */
	 ...
	 * <code>compilationUnits</code> in <code>project</code> unless the result of
	 * checkPreConditions contains a fatal error
	 *
	 * @param project
	 *            the project to clean up
	 * @param compilationUnits
	 *            an array of compilation units to clean up, all member of
	 *            <code>project</code>
	 * @param monitor
	...
	/**
	 * Create an <code>ICleanUpFix</code> which fixes all problems in
	 * <code>context</code> or <code>null</code> if nothing to fix.
	 *
	 * @param context
	 *            a context containing all information requested by
	 *            {@link #getRequirements()}
