 ...
 *
 * Originally copied from org.eclipse.jdt.internal.corext.refactoring.base.JavaStatusContext
 *
 * Contributors:
...
/**
 * A Java element context that can be used to annotate a
...
public abstract class JavaStatusContext extends RefactoringStatusContext {
	 ...
	 *
	 * @param member
	 *            the java member for which the context is supposed to be
	 *            created
	 * @return the status entry context or <code>null</code> if the context
	 *         cannot be created
	 */
	 ...
	 *
	 * @param declaration
	 *            the import declaration for which the context is supposed to be
	 *            created
	 * @return the status entry context or <code>null</code> if the context
	 *         cannot be created
	 */
	 ...
	 *
	 * @param method
	 *            the method binding for which the context is supposed to be
	 *            created
	 * @return the status entry context or <code>Context.NULL_CONTEXT</code> if
	 ...
	 *
	 * @param typeRoot
	 *            the type root containing the error
	 * @return the status entry context or <code>Context.NULL_CONTEXT</code> if
	 *         the context cannot be created
	 */
	 ...
	 *            the type root containing the error
	 * @param range
	 *            the source range that has caused the error or
	 ...
	 *            the type root containing the error
	 * @param selection
	 *            a selection denoting the source range that has caused the
	 *            error
	 *
	 * @return the status entry context or <code>Context.NULL_CONTEXT</code> if
	 *         the context cannot be created
	...
	/**
	 * Returns the class file this context is working on. Returns
	 * <code>null</code> if the context is not a binary context.
	 *
