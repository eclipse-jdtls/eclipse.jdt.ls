...
public interface IReorgPolicy extends IReorgDestinationValidator {
	...
	public static interface IMovePolicy extends IReferenceUpdating, IQualifiedNameUpdating, IReorgPolicy {
		...
		/**
		 * Checks if <b>Java</b> references to the selected element(s) can be
		 * updated if moved to the selected destination. Even if
		 * <code>false</code>, participants could still update non-Java
		 * references.
		 *
		 * @return <code>true</code> iff <b>Java</b> references to the moved
