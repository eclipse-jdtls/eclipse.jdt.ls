 ...
 *
 * Copied from package org.eclipse.jdt.ui.cleanup.CleanUpRequirements
 *
 * Contributors:
...
public final class CleanUpRequirements {
	 ...
	 *
	 * @param requiresAST
	 *            <code>true</code> if an AST is required
	 * @param requiresFreshAST
	 *            <code>true</code> if a fresh AST is required
	 * @param requiresChangedRegions
	 *            <code>true</code> if changed regions are required
	 * @param compilerOptions
	 *            map of compiler options or <code>null</code> if no requirements
	 */
	 ...
	 * <p>
	 * <strong>Note:</strong> This should return <code>false</code> whenever
	 * possible because creating an AST is expensive.
	 * </p>
	 *
	 * @return <code>true</code> if the {@linkplain CleanUpContext context} must
	 *         provide an AST
	 */
	...
	/**
	 * Tells whether a fresh AST, containing all the changes from previous clean
	 * ups, will be needed.
	 *
	 ...
	 * The changed regions are the regions which have been changed between the last
	 * save state of the compilation unit and its current state.
	 * <p>
	 * Has only an effect if the clean up is used as save action.
	 * </p>
	 * <p>
	 * <strong>Note:</strong>: This should return <code>false</code> whenever
	 * possible because calculating the changed regions is expensive.
	 * </p>
	 *
	 * @return <code>true</code> if the {@linkplain CleanUpContext context} must
	 *         provide changed regions
	 */
