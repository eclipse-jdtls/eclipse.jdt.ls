 ...
 *
 * Copied from package org.eclipse.jdt.internal.ui.fix.LambdaExpressionsCleanUp
 *
 * Contributors:
...
public class LambdaExpressionsCleanUp extends AbstractCleanUp {
	...
	@Override
	public ICleanUpFixCore createFix(CleanUpContext context) throws CoreException {
		...
		return LambdaExpressionsFix.createCleanUp(compilationUnit, isEnabled(CleanUpConstants.USE_LAMBDA), isEnabled(CleanUpConstants.USE_ANONYMOUS_CLASS_CREATION));
	}
