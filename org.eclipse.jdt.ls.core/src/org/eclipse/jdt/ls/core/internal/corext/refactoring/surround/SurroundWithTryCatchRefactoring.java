 ...
 *
 * Originally copied from org.eclipse.jdt.internal.corext.refactoring.surround.SurroundWithTryCatchRefactoring
 *
 * Contributors:
...
/**
 * Surround a set of statements with a try/catch block or a try/multi-catch
 * block.
 *
 * Special case:
 *
 ...
 * declaration without initializer. So the body of the try/catch block only
 * consists of new assignments. In this case we can't move the selected nodes
 * (e.g. the declaration) into the try block.
 */
