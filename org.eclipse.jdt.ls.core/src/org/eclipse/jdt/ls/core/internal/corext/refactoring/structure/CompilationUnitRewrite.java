 ...
 *
 * Copied from /org.eclipse.jdt.ui/src/org/eclipse/jdt/internal/corext/refactoring/structure/CompilationUnitRewrite.java
 *
 * Contributors:
		...
		try {
			...
			if (needsImportRewrite) {
				...
				if (!isEmptyEdit(importsEdit)) {
					...
					String importUpdateName = "Update imports";
