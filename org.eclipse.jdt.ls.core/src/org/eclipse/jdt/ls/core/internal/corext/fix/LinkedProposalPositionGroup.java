 ...
 *
 * Copied from /org.eclipse.jdt.ui/src/org/eclipse/jdt/internal/corext/fix/LinkedProposalPositionGroup.java
 *
 * Contributors:
...
public class LinkedProposalPositionGroup {
	...
	public static class Proposal {
		...
		public Proposal(String displayString, int relevance) {
	...
	private static final class JavaLinkedModeProposal extends Proposal {
		...
		public JavaLinkedModeProposal(ICompilationUnit unit, ITypeBinding typeProposal, int relevance) {
			super(BindingLabelProvider.getBindingLabel(typeProposal,
					JavaElementLabels.ALL_DEFAULT | JavaElementLabels.ALL_POST_QUALIFIED), relevance);
	...
	public void addProposal(String displayString, int relevance) {
		addProposal(new Proposal(displayString, relevance));
	}
