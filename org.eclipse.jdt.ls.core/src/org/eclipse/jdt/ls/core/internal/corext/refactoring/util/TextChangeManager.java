 ...
 *
 * Originally copied from org.eclipse.jdt.internal.corext.refactoring.util.TextChangeManager
 *
 * Contributors:
 ...
 * <code>ICompilationUnit</code> or <code>IFile</code> and
 * <code>TextChange</code> objects.
 */
public class TextChangeManager {
	...
	/**
	 * Adds an association between the given compilation unit and the passed change
	 * to this manager.
	 *
	 * @param cu
	 ...
	 * unit. If the manager does not already manage an association it creates a one.
	 *
	 * @param cu
	 ...
	 * @return <code>true</code> if any text changes are managed for the specified
	 *         compilation unit and <code>false</code> otherwise
	 */
