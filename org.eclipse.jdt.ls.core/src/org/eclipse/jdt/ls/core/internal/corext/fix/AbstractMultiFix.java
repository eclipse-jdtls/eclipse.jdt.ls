 ...
 *
 * Copied from package org.eclipse.jdt.internal.ui.fix.AbstractMultiFix
 *
 * Contributors:
...
public abstract class AbstractMultiFix extends AbstractCleanUp implements IMultiFix {
	...
	@Override
	public final ICleanUpFixCore createFix(CleanUpContext context) throws CoreException {
	...
	/**
	 * Utility method to: count number of problems in <code>problems</code> with
	 * <code>problemId</code>
	 *
	 * @param problems
	 *            the set of problems
	 * @param problemId
	 *            the problem id to look for
	...
	/**
	 * Returns unique problem locations. All locations in result have an id element
	 * <code>problemIds</code>.
	 *
	 * @param problems
	 *            the problems to filter
	 * @param problemIds
	 *            the ids of the resulting problem locations
