 ...
 *
 * Copied from /org.eclipse.jdt.ui/src/org/eclipse/jdt/internal/corext/fix/UnusedCodeFix.java
 *
 * Contributors:
...
public class UnusedCodeFix extends CompilationUnitRewriteOperationsFixCore {
	...
	private static class RemoveUnusedMemberOperation extends CompilationUnitRewriteOperation {
		...
		private void removeParamTag(ASTRewrite rewrite, SingleVariableDeclaration varDecl, TextEditGroup group) {
			/*	TODO Martin	if (varDecl.getParent() instanceof MethodDeclaration) {
