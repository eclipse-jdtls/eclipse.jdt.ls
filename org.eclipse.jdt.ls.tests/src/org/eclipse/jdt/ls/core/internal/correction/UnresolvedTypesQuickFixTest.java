...
public class UnresolvedTypesQuickFixTest extends AbstractQuickFixTest {
	...
	public void testArrayTypeInStatement() throws Exception {
		...
		buf.append("    }\n");
		buf.append("}\n");
		Expected e1 = new Expected("Change to 'Serializable' (java.io)", buf.toString());
		...
		buf.append("    }\n");
		buf.append("}\n");
		Expected e2 = new Expected("Change to 'ArrayList' (java.util)", buf.toString());
		...
		buf.append("    }\n");
		buf.append("}\n");
		Expected e5 = new Expected("Change to 'ArrayListenerHelper' (com.sun.javafx.collections)", buf.toString());
		...
		buf.append("    }\n");
		buf.append("}\n");
		Expected e6 = new Expected("Add type parameter 'ArrayListExtra' to 'foo()'", buf.toString());
		...
		buf.append("    }\n");
		buf.append("}\n");
		Expected e7 = new Expected("Add type parameter 'ArrayListExtra' to 'E'", buf.toString());

		assertCodeActions(cu, e1, e2, e5, e6, e7);
	}
	...
	public void testPrimitiveTypeInFieldDecl() throws Exception {
		...
		buf.append("}\n");
		Expected e1 = new Expected("Change to 'double'", buf.toString());
		...
		buf.append("}\n");
		Expected e2 = new Expected("Change to 'Float' (java.lang)", buf.toString());
		...
		buf.append("}\n");
		Expected e3 = new Expected("Change to 'FLOAD' (com.sun.org.apache.bcel.internal.generic)", buf.toString());
		...
		buf.append("}\n");
		Expected e4 = new Expected("Change to 'Flood' (com.sun.scenario.effect)", buf.toString());
		...
		buf.append("    float vec= 1.0;\n");
		buf.append("}\n");
		Expected e5 = new Expected("Change to 'float'", buf.toString());
		...
		buf.append("}\n");
		Expected e6 = new Expected("Change to 'FlowList' (com.sun.org.apache.xalan.internal.xsltc.compiler)",
				buf.toString());
		...
		buf.append("    floot vec= 1.0;\n");
		buf.append("}\n");
		Expected e7 = new Expected("Add type parameter 'floot' to 'E'", buf.toString());
